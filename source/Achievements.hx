...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Cool Skill",					"Beat 'First-rapping' ",							'first_song',				true],
		["Play osu! mania too much",	"Beat 'First-rapping' with no Misses.",				'first_song_FC',			true],
		["How many miss lol",			"Beat 'Being-serious' ",							'second_song',				true],
		["Cheater!!!!!!",				"Beat 'Being-serious' with no Misses.",				'second_song_FC',			true],
		["NOOB lol",					"Beat Any songs with Botplay.",						'bot_play',					true]
	];
